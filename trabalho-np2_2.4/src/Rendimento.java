...
public class Rendimento {
	...
	public String toString() {
		...
		try {
			System.out.println("Nota NP1: " + notas.getNotaNP1());
			System.out.println("Nota NP2: " + notas.getNotaNP2());
			System.out.println("Nota Reposição: " + notas.getReposicao());
			System.out.println("Nota Exame: " + notas.getExame());
