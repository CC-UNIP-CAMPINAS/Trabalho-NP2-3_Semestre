...
public class Rendimento {
	...
	public Rendimento(Aluno aluno, Curso curso, double np1, double np2, double rep, double aExame, double med,
			boolean aprov) {
	...
	public boolean equals(Object o) {
		...
		if (o == null || !(o instanceof Rendimento))
			return false;

		Rendimento a = (Rendimento) o;

		return aluno.equals(a.aluno) && curso.equals(a.curso);
	}
